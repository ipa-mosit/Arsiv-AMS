...
public class ShellApp{
    ...
    public static RunnerData runnerData;
    public static BiConsumer<TextIO,RunnerData>appRunner;
    ...
    public ShellApp(int porta){
        port=porta;
        runnerData=null;
        // textIo=TextIoFactory.getTextIO();
        // BiConsumer<TextIO,RunnerData>appRunner=new ShellDialogs();
 
    }
    public void basla () {
        if (port==null){
        appRunner=new ShellDialogs();
