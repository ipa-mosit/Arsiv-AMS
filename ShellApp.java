...
public class ShellApp{
    ...
    BiConsumer<TextIO,RunnerData>appRunner;
    int port;
    // Scanner giris = new Scanner(System.in);
    
    public void ShellApp(){
        runnerData=null;
        this.textIo=TextIoFactory.getTextIO();
        this.appRunner=new TextIoUiApp();
        this.appRunner.accept(textIo,null);

    }
    public void ShellApp(int port){
        this.port=port;
        runnerData=null;
        this.textIo=TextIoFactory.getTextIO();
    ...
    public void appRunner.accept(TextIO textIO,RunnerData runnderData){
